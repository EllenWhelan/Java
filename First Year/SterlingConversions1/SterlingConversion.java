...
import javax.swing.JOptionPane;
  ...
  1. Did I use appropriate CONSTANTS instead of numbers within the code?
      Mark out of 10: 8 
      I used only the constants given in the question and did not define any of my own.  
  ...
  8. Did I compute the answer correctly for all cases?
      Mark out of 20:  18
      I tested the code using normal values as well as extreme values.
...
public class SterlingConversions {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, oldPounds + " old pound, " + oldShillings +
				" old shilling and " + oldPence + " old pence = " + "£" + output );
